...
class CommandProcessor {
 ...
 protected:
  ...
  struct ZPDStats {
    ...
    uint64_t same_slot_strict_waits = 0;
    uint64_t same_slot_strict_wait_ticks = 0;
    uint64_t same_slot_strict_wait_failures = 0;
    uint64_t stale_resolve_drops = 0;
    uint64_t nonzero_delta_wrap_saved = 0;
  ...
  // Checks that the report's slot sequence is not reused.
