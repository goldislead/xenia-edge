...
#define FORMAT_INFO(texture_format, format, block_width, block_height, bits_per_pixel, fixed, component_bits_0, component_bits_1, component_bits_2, component_bits_3, point_only) \
    {xenos::TextureFormat::texture_format,  FormatType::format, block_width, block_height, bits_per_pixel, fixed, {component_bits_0, component_bits_1, component_bits_2, component_bits_3}, point_only}
...
unsigned char FormatInfo::GetWidthShift(uint32_t gpu_format) {
	#define		FORMAT_INFO(texture_format, format, block_width, block_height, bits_per_pixel, fixed, component_bits_0, component_bits_1, component_bits_2, component_bits_3, point_only)		GetShift(block_width)
...
#define		FORMAT_INFO(texture_format, format, block_width, block_height, bits_per_pixel, fixed, component_bits_0, component_bits_1, component_bits_2, component_bits_3, point_only)		GetShift(block_height)
	alignas(XE_HOST_CACHE_LINE_SIZE)
