...
bool RenderTargetCache::Update(bool is_rasterization_done,
  ...
  // With the offset in the bases the draw touches nothing between a base and
  // the scissor top, that's the allocation the base points into. Claims start
  // at the scissor and aren't clamped between the bases, a claim starting
  // past the base distance would be cut to nothing.
