...
//
//    D3D sums A and B. Still, the true 100% confirmed meaning of the split
//    isn't known. But for every 50 titles that merely ask for the summed ZPass,
...
struct XenosZPDReport {
  ...
  // Native query plus the pre-test coverage from Total, if
